...
TicTacToeDialog::TicTacToeDialog(NeuralNetwork<double> &_network, QWidget *parent) :
    network(_network),
    QDialog(parent),
    ui(new Ui::TicTacToeDialog)
{
    ui->setupUi(this);
...
void TicTacToeDialog::buttonClicked(bool)
{
...
void TicTacToeDialog::paintEvent(QPaintEvent *e)
{
